    ...
    (function (productList) {
        var ProductListCtrl = /** @class */ (function () {
            function ProductListCtrl() {
                ...
                var newProduct = new app.domain.Product(3, "Saw", "TBX-002", new Date(2002, 3, 1), 16.95, "15-inch steel blade band saw", "http://openclipart.org/image/300px/svg_to_png/27070/egopre911_saw.png");
